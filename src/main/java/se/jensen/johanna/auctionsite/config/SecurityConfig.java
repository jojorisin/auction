...
public class SecurityConfig {
  ...
  /**
   * Dedicated security filter chain for WebSockets. Note: Permitting all requests to /ws/** for
   * ease of testing and handshake handling in the current development phase.
   */
  @Bean
